...
def new_post():
    ...
    if form.validate_on_submit():
        if form.picture.data :
            ...
            post = Post(title= tiff_path + " " + str(os.path.join('flask_server', 'static', 'post_picture', tiff_name)), tiff = tiff_path, content=form.content.data, mask=save_picture_post(mask, "mask.png"),
